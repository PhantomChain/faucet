...
$(document).ready(function() {
    ...
    $.get("api/faucet", (info) => {
        ...
        $("#ppc").html(info.payPerClick.toFixed(8) + " XNC");
        ...
        $("#submit").click(() => {
            ...
            {
                error.html("Please enter a valid Phantom address and solve the captcha");
            ...
            $.post("api/faucet", {"address": addr, "g-recaptcha-response": captchaResp}, (resp) => {
                ...
                success.html(`${info.payPerClick} XNC added to your account!`);
